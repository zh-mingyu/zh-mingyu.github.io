...
<style>
  ...
  .opensource-card { display: flex; flex-direction: column; align-items: center; text-align: center; min-height: 200px; padding: 1rem 0.85rem; border-radius: 15px; border: 1px solid rgba(1,47,99,0.08); background: #fff; box-shadow: 0 6px 18px rgba(1,47,99,0.07); transition: transform 0.24s ease, border-color 0.24s; }
...
<div class="language-switcher" id="research-language-switcher">
  ...
  <div class="lang-panel active" data-lang-panel="en" role="tabpanel">
    <div class="research-intro">
      <p>Welcome to my homepage! I'm currently a senior undergraduate student (and incoming graduate student) in the <a href="https://www.sc.sdu.edu.cn">School of Software</a>, <a href="https://www.sdu.edu.cn">Shandong University</a>, under the supervision of Prof. <a href="https://liqiangnie.github.io/index.html">Liqiang Nie</a> and Prof. <a href="https://faculty.sdu.edu.cn/huyupeng1/zh_CN/index.htm">Yupeng Hu</a>.</p>
      <p>My research interests mainly focus on <strong>Multimodal Large Language Models, robust representation learning, and trustworthy AI</strong>.</p>
    </div>
  </div>
  
  <div class="lang-panel" data-lang-panel="zh" role="tabpanel">
    <div class="research-intro">
      <p>欢迎来到我的主页！我目前是山东大学<a href="https://www.sc.sdu.edu.cn">软件学院</a>的本科生（已保研至本院实验室），师从 Prof. <a href="https://liqiangnie.github.io/index.html">Liqiang Nie</a> 与 Prof. <a href="https://faculty.sdu.edu.cn/huyupeng1/zh_CN/index.htm">Yupeng Hu</a>。</p>
      <p>我的研究兴趣主要聚焦于<strong>多模态大语言模型、鲁棒表征学习与可信AI研究</strong>。</p>
    </div>
  </div>
</div>
...
<div class="opensource-section" id="open-source-projects">
  ...
  <div class="opensource-grid">
    <div class="opensource-card">
      <div class="opensource-card-title">ShapePhys</div>
      <div class="opensource-card-meta"><span class="i18n-en-inline">Under Review · TPAMI</span><span class="i18n-zh-inline">在投 · TPAMI</span></div>
      <div style="font-size: 0.75rem; color: #586069; margin-bottom: 0.5rem; text-align: left;">Struct-Harmonized Adaptive Physical Rectification, utilizing a precise 4-token structure.</div>
      <div class="opensource-card-links">
        <a href="https://github.com/zh-mingyu" target="_blank">Repository</a>
      </div>
    </div>
    <div class="opensource-card">
...
<div class="news-section" id="news">
  ...
  <div class="news-grid">
    <div class="news-card">
      ...
      <div class="news-text">🎓 I am extremely honored to be recommended for graduate study (保研) at the School of Software, SDU! Furthermore, our extensive work on <strong>ShapePhys</strong> is currently under preparation for TPAMI submission.</div>
    </div>
    <div class="news-card">
      <div class="news-date">2026.04.10</div>
      <div class="news-text">🎉🎉 Honored to receive the university-level <strong>"Excellent Report"</strong> and <strong>"Excellent Individual"</strong> awards for our recent social practice project. Thanks to all teammates!</div>
    </div>
    <div class="news-card">
      <div class="news-date">2026.03.03</div>
      <div class="news-text">🎉🎉 One paper (ConeSep) was accepted by <strong>CVPR 2026</strong>! Congratulations to all co-authors!</div>
    </div>
    <div class="news-card">
      <div class="news-date">2026.01.18</div>
      <div class="news-text">🎉🎉 One paper (HINT) has been accepted to <strong>ICASSP 2026</strong>! Congratulations to our co-authors!</div>
    </div>
    <div class="news-card">
...
<div id="publications-wrapper">
  ...
  <div id="paper-shapephys" class="paper-box floating-card" data-tags="In Submission, First Author, Multimodal Understanding">
    <div class="paper-box-image">
      <div class="badge">TPAMI</div>
      <!-- Add your ShapePhys image path here -->
      <img src="images/placeholder.png" alt="ShapePhys" width="100%" style="border-radius: 8px;">
    </div>
    <div class="paper-box-text">
      <p><strong>ShapePhys: Struct-Harmonized Adaptive Physical Rectification</strong></p>
      <p><em><span class="primary-gradient-text">Mingyu Zhang</span></em>, et al.</p>
      <p style="font-size: 0.85em; color: #586069; margin-top: 5px;">A novel framework utilizing a robust 4-token structural configuration to deliver profound anti-noise capabilities and significant retrieval achievements.</p>
      <div class="badge-container">
        <span class="inner-tag-badge">In Submission</span>
      ...
      <div class="paper-link-container">
        <a href="#" class="paper-link-btn">[Drafting]</a>
      </div>
    </div>
  </div>
...
# 🏆 Honors and Awards
*   *2026.04*, **Excellent Report & Excellent Individual**, University-level Social Practice.
*   *2025.10*, **Grand Prize**, CICAS Smart Power Scenario Competition.

# 📖 Educations
*   *2023.09 - Present*, Undergrad in the School of Software, Shandong University. (Recommended for Graduate Study)
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const tagOrder = ['First Author', 'In Submission', 'CVPR 2026', 'ICASSP 2026', 'Multimodal Understanding', 'Robustness'];
